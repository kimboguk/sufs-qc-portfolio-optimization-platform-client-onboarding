  ...
  const validateCurrentStep = (): boolean => {
    ...
    switch (currentStep) {
      ...
      case 7:
        ...
        return true
      case 8:
        // Step 8: 규제 제약 여부 확인 + "예"일 때 규제 내용도 확인
  ...
  return (
    <div className="flex items-start justify-center bg-white px-4">
      <div className="w-full max-w-2xl">
        ...
        <div className="bg-white rounded-lg border border-gray-200 shadow-sm p-8 mb-8 h-96 overflow-y-auto">
...
case 8:
      ...
      return (
        <div>
          ...
          {/* "예"를 선택하면 같은 화면에 입력창 표시 */}
          {formData.hasRegulationConstraints === true && (
            <div className="mt-6">
              <label className="block text-sm font-medium text-gray-700 mb-2">
                {ONBOARDING_QUESTIONS.regulationDetails.label}
              </label>
              <textarea 
